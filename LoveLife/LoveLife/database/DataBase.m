...
+ (NSString *)setUpDB {
	...
	NSString *realPath = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory , NSUserDomainMask, YES) objectAtIndex:0] stringByAppendingPathComponent:@"lovelife.db"];
	NSString *sourcePath = [[NSBundle mainBundle] pathForResource:@"lovelife" ofType:@"db"];
